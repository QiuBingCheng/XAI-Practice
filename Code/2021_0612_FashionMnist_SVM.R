...
xtrain <- readRDS("D:/AmberChu/Amber/Fashion_mnist/data/xtrain.rds")
xtest <- readRDS("D:/AmberChu/Amber/Fashion_mnist/data/xtest.rds")
trainy <- readRDS("D:/AmberChu/Amber/Fashion_mnist/data/trainy.rds")
testy <- readRDS("D:/AmberChu/Amber/Fashion_mnist/data/testy.rds")
#### build model ------------------------------------------------------------------------------------
## encoder
...
save_model_hdf5(model,"C:/Users/User/Desktop/Amber/Fashion_mnist/2021_0612/CAE_SVM.h5")


model <- load_model_hdf5("C:/Users/User/Desktop/Amber/Fashion_mnist/2021_0612/CAE_SVM.h5")
summary(model)
...
dec4<- get_layer(model,name="decoder4")
...
paste("reconstruction error: "
      ,k_get_value(k_mean(reconstruction_error))) # 0.0248633357343601  
...
sum(avg_error)/10 #0.02634594 (check)
#plot error
library(ggplot2)
eval %>% group_by(class) %>% summarise(avg_error = mean(error)) %>%
...
# saveRDS(cov,"C:/Users/User/Desktop/Amber/Fashion_mnist/2021_0612/cov_cae.rds")
cov<- readRDS("C:/Users/User/Desktop/Amber/Fashion_mnist/2021_0612/cov_cae.rds")
...
# PC123
sum(cov$Variance[1:3])
label <- c("T-shirt","Trouser","Pullover","Dress","Coat","Sandal","Shirt","Sneaker","Bag","Ankle boot")
tmp <- data.table(fashion_mnist$test$y)
...
pcs%>%
  ...
  ggtitle('CAE+SVM: PCA for Latent Representation')+
